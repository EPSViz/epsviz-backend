...
#       return(c(cutoff.date, no.quarters, consensus.at.predict.quarter,prediction.date)) # if is.na(consensus), then prediction not ready yet.
#     }
#   }
#   return("error")
...
# # test <- do.call(rbind, lapply(trends, as.data.frame))
# # test
...
historicalDataFrame(earnings, trends)
